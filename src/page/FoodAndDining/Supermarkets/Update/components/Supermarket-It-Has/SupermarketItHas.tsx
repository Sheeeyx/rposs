...
import useUpdateSuperMarketItHas from "../../../../../../services/mutation/food-and-dining/supermarket/update/it-has/use-update-supermarket-ithas";
...
export const SupermarketItHas = ({dataItHas}:any) => {
    const {id} = useParams();
    const  [itHasList, setitHasList] = useState([]);
    const getItHasTags = useGetItHasTags();
    const { mutate, isLoading } = useUpdateSuperMarketItHas(id);
