...
import useUpdateSuperMarketDetail from '../../../../../../services/mutation/food-and-dining/supermarket/update/detail/use-update-detail';
const { Option } = Select;

const { Title } = Typography;


export const SupermarketDetail = ({data}) => {

    const params = useParams();
    const { mutate } = useUpdateSuperMarketDetail();
    ...
    const onFinish = (data, id) => {
        mutate(
            ...
            {
                onSuccess: () => {
                    queryClient.invalidateQueries(`detail-supermarket${params.id}`);
        ...
        <div>
            <Form onFinish={(data) => onFinish(data, params.id)}>
                    <Row justify="start" gutter={30}>
                        <Col span={9}>
                            <FormItem
                                label={"Name of your supermarket"}
                                name="name"
                                ...
                                rules={[
                                    {
                                        required: true,
                                        message:
                                            "Please enter name of your supermarket",
                                    },
                                ]}
                            >
                                <Input />
                    ...
                    >
                        <Col span={9}>
                            ...
                            <Col span={9}>
                                <p className="type">Supermarket type :</p>
                                <Select 
