...
import useUpdateBakeryItHas from "../../../../../../services/mutation/food-and-dining/bakery/update/it-has/use-update-bakery-ithas";
...
export const BakeryItHas = ({dataItHas}:any) => {
    const {id} = useParams();
    const  [itHasList, setitHasList] = useState([]);
    const getItHasTags = useGetItHasTags();
    const { mutate, isLoading } = useUpdateBakeryItHas(id);
