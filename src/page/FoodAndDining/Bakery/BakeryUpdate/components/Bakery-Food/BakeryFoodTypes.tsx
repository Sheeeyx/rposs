...
import useUpdateBakeryFoodOption from "../../../../../../services/mutation/food-and-dining/bakery/update/food/use-update-food";
...
export const BakeryFoodType = ({food}:any) => {

    const {id} = useParams();
    const  [foodTypeList, setfoodTypeList] = useState([]);
    const getFoodTypeTags = useGetFoodTypeTags();
    const { mutate, isLoading } = useUpdateBakeryFoodOption(id);
