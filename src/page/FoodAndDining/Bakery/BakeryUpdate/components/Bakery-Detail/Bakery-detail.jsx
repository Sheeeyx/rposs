...
export const BakeryDetail = ({data}) => {

    const params = useParams();
    const { mutate } = useUpdateBakeryDetail();
    ...
    const onFinish = (data, id) => {
        mutate(
            ...
            {
                onSuccess: () => {
                    queryClient.invalidateQueries(`details-bakery${params.id}`);
            ...
            <Form onFinish={(data) => onFinish(data, params.id)}>
                    ...
                    >
                        <Col span={9}>
                            ...
                            <Col span={9}>
                                <p className="type">Bakery type :</p>
                                <Select 
