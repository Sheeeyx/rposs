...
import useUpdateSuperMarketServiceOption from "../../../../../../services/mutation/food-and-dining/supermarket/update/service-options/use-update-service-option";
import useUpdateFoodOptionService from "../../../../../../services/mutation/food-and-dining/food-service/update/service-options/use-update-service-option";
...
export const FoodServiceServiceOption = ({dataService}:any) => {

    const { id } = useParams();
    const  [ serviceOptionsList, setserviceOptionsList ] = useState([]);
    const getServiceOptionTags =  useGetServiceOptionTags();
    const { mutate, isLoading } = useUpdateFoodOptionService(id);
