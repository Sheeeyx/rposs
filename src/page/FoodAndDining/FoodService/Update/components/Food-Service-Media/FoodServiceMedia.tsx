...
import useUpdateFoodServiceMedia from "../../../../../../services/mutation/food-and-dining/food-service/update/media/use-update-supermarket-media";

const { Title } = Typography;


export const FoodServiceMedia = ({media}:any) => {
    const [imgIdList, setImgIdList] = useState([]);
    const params = useParams();
    const {mutate} = useUpdateFoodServiceMedia();
