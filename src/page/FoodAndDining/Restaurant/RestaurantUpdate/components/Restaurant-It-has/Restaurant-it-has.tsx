...
import useUpdateRestaurantItHas from "../../../../../../services/mutation/food-and-dining/restaurant/update/it-has/use-update-restaurant-ithas";
...
export const RestaurantItHas = ({dataItHas}:any) => {
    const {id} = useParams();
    const  [itHasList, setitHasList] = useState([]);
    const getItHasTags = useGetItHasTags();
    const { mutate, isLoading } = useUpdateRestaurantItHas(id);
