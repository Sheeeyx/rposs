...
import useCreateTakeout from "../../../../services/mutation/food-and-dining/takeout/create/use-create-takeout";
...
export const TakeoutCreate= () => {
    const navigate = useNavigate();
    const takeoutCreate = useCreateTakeout();
    ...
    const onSubmit = (data) => {
        ...
        takeoutCreate.mutate(
            ...
            {
                onSuccess: (res) => {
                    toast.success("Takeout has been successfully created!");
                    navigate("/food-and-dining/takeout/list");
                },
            ...
            <div>
                <Form  onFinish={onSubmit}>
                    ...
                    <Col span={9}>
                        ...
                        <Col span={9}>
                            <FormItem
                                ...
                                {
                                    required: true,
                                    message: "Please enter Takeout type",
                                }
                                ]}
                            >
                                <Select 
                    ...
                    <Row style = {{margin: "18px 0"}}>
                        <FormItem>
                           ...
                           {(checkImg && certificateImg.length === 0) &&
                                <p style={{color: 'red'}}>Upload Certificate !</p>
                            }
                        </FormItem>
                    </Row>
                    <Row>
                    ...
                    <Row justify="start" gutter={30}>
                        ...
                        <Col span={9}>
                            <FormItem label={"Instargam URL"} name="instargam_url">
                                <Input />
                            </FormItem>
                        </Col>
                    </Row>
