...
import useUpdateTakeOutFoodOption from "../../../../../../services/mutation/food-and-dining/takeout/update/food/use-update-takeout";
...
export const TakeOutFoodType = ({food}:any) => {

    const {id} = useParams();
    const  [foodTypeList, setfoodTypeList] = useState([]);
    const getFoodTypeTags = useGetFoodTypeTags();
    const { mutate, isLoading } = useUpdateTakeOutFoodOption(id);
