...
import useUpdateTakeOutItHas from "../../../../../../services/mutation/food-and-dining/takeout/update/it-has/use-update-takeout-ithas";
...
export const TakeOutItHas = ({dataItHas}:any) => {
    const {id} = useParams();
    const  [itHasList, setitHasList] = useState([]);
    const getItHasTags = useGetItHasTags();
    const { mutate, isLoading } = useUpdateTakeOutItHas(id);
