...
import useUpdateTakeOutMedia from "../../../../../../services/mutation/food-and-dining/takeout/update/media/use-update-takeout-media";

const { Title } = Typography;


export const TakeOutMedia = ({media}:any) => {
    const [imgIdList, setImgIdList] = useState([]);
    const params = useParams();
    const {mutate} = useUpdateTakeOutMedia();
