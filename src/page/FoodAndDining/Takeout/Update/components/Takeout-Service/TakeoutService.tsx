...
import useUpdateTakeOutServiceOption from "../../../../../../services/mutation/food-and-dining/takeout/update/service-options/use-update-service-option";
    ...
    useEffect(()=>{
        ...
        const handleSubmit = () => {
                mutate(
                    ...
                    {
                        onSuccess: () => {
                            queryClient.invalidateQueries(`detail-takeout${id}`);
