...
import useCreateTravalling from "../../../../services/mutation/use-create-travalling";

const Datapickers: any = DatePicker

const { Title } = Typography;

const TravalingCreate = () => {


    const [imgId, setImgId] = useState([]);
    const navigate = useNavigate();
    const { mutate } = useCreateTravalling();
    ...
    const onSubmit = (data:any) => {
      ...
      mutate({
        ...
        start_date: startDate,
            ...
            onSuccess: () => {
                toast.success("Travelling Deal create successfully");
...
export default TravalingCreate;
